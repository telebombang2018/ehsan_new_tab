...
function check_markdown(text) 
 ...
 if msg.content_.ID == "MessageContact" then
	  tabchi.importContacts(msg.content_.contact_.phone_number_, (msg.content_.contact_.first_name_ or '--'), '#energy_team', msg.content_.contact_.user_id_)
        print("ConTact Added")
